...
export default new class {
   ...
   * @returns {Promise<any>}
   */
  async request(method, path, options, token) {
  ...
  get(path, query, token) {
    ...
    return this.request('GET', path, options, token)
  }
  ...
  patch(path, data, token) {
    ...
    return this.request('PATCH', path, options, token)
  }
  ...
  post(path, data, token) {
    ...
    return this.request('POST', path, options, token)
  }
}()
