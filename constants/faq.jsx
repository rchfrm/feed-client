...
const faq = [
  {
    ...
    answer: (
      <div>
        <p>To use <Feed />, you'll need to be an admin of a Facebook (business) Page as a minimum. If you are using Instagram, you'll need a <a href="https://help.instagram.com/502981923235522" target="_blank" rel="noopener noreferrer">business profile</a> and make sure it's <a href="https://help.instagram.com/399237934150902" target="_blank" rel="noopener noreferrer">linked to your Facebook Page</a>.</p>
  ...
  },
  {
    ...
    answer: (
      <div>
        <p>It's likely that your Facebook Page and Instagram business profile are not quite fully linked. Luckily it’s a quick fix! <a href="https://www.facebook.com/business/help/898752960195806" target="_blank" rel="noopener noreferrer">Adding your Instagram account to your Facebook Page</a> only takes a couple of minutes.</p>
  ...
  },
  {
    ...
    answer: (
      <div>
        <p>If you haven’t run ads on Facebook or Instagram before, to use the beta version of <Feed /> you’ll have to put your card details into Facebook separately.</p>
        <p>It only takes a couple of minutes to do this: just add your payment method in <a href="https://www.facebook.com/ads/manager/account_settings/account_billing" target="_blank" rel="noopener noreferrer">the billing section of Facebook’s Ads Manager.</a></p>
      </div>
    ),
  },
  {
    ...
    answer: (
      <div>
        <p>Make sure you've added your accounts from the 'accounts' page. You'll start seeing data the day after you do this. Once you've been using <Feed /> for long enough, we'll show you your follower and engagement data over time.</p>
  ...
  },
  {
    ...
    answer: (
      <div>
        ...
        <p>We recommend spending £3/day, which lets <Feed /> find new fans and also remind people who have engaged with you in the past.</p>
  ...
  },
  {
    ...
    answer: (
      <div>
        <p>When you've set up your account and entered your budget, <Feed /> will set up and submit your ads for approval. Your ads should start running within 12 hours, at which point you can see how they are performing on the 'results' page.</p>
      </div>
    ),
  },
  {
    ...
    answer: (
      <div>
        ...
        <p><Feed /> won't promote a post that isn't approved, and will simply skip to the next one.</p>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <div>
        <p>We built <Feed /> to help artists build an audience of real people, not a bunch of fake followers. These are the people who will stream and download your music and buy gig tickets, merch, CDs and vinyls.</p>
        ...
        <p>It's early days, but some of the first artists using <Feed /> are on track to double their audience across platforms in a matter of months.</p>
      </div>
    ),
  },
  {
    ...
    answer: (
      <div>
        <p><Feed /> works best when you are regularly posting on social media, releasing music and playing live. In other words, just keep doing what you're doing!</p>
        <p>You don't have to be posting every day, just whatever 'regularly' means for you.</p>
        <p><Feed /> always work best alongside artists who are consistently engaging with their fans and staying active in the various parts of their music career.</p>
      </div>
    ),
  },
];
