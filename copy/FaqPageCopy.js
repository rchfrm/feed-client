...
If you want the link on a specific post to be different to the default link, just head to the posts page and change the link on the post itself.  
  ...
  [
    `#### What if I haven't added my card details to Facebook before?`,
    `If you haven't run ads on Facebook or Instagram before, to use the beta version of **Feed** you'll have to put your card details into Facebook separately. 
    
It only takes a couple of minutes to do this: just add your payment method in [the billing section of Facebook's Ads Manager](https://www.facebook.com/micro_site/url/?click_from_context_menu=true&country=GB&destination=https%3A%2F%2Fwww.facebook.com%2Fads%2Fmanager%2Faccount_settings%2Faccount_billing&event_type=click&last_nav_impression_id=0VZfFSLchTdNInot4&max_percent_page_viewed=46&max_viewport_height_px=766&max_viewport_width_px=1440&orig_http_referrer=https%3A%2F%2Fwww.google.com%2F&orig_request_uri=https%3A%2F%2Fwww.facebook.com%2Fbusiness%2Fhelp%2F132073386867900&primary_cmsid=132073386867900&primary_content_locale=en_GB&region=emea&scrolled=true&session_id=2LaSJTkVA12TCm5I5&site=fb4b&extra_data[view_type]=v3_initial_view&extra_data[site_section]=help&extra_data[placement]=%2Fbusiness%2Fhelp%2F132073386867900).`,
  ],
...
It’s easy to change your budget from the posts page. If you want to turn off digital ads for a period, just set the budget to 0. To start running ads again, just enter a budget again.
  ...
  [
    ...
    `When you've set up your account and entered your budget, **Feed** will set up and submit your ads for approval. Your ads should start running within 12 hours, at which point you can see how they are performing on the ‘results' page.`,
  ],
...
We believe a steady and patient approach pays off in the long-run. Try smoothing your spend out over a longer period, rather than blowing your entire marketing budget in a few days around a key event. You can still increase your spend around these events, just make sure you keep something back for the ‘in between’ periods.`,
  ...
  [
    `#### What else can I do to maximise **Feed's** impact?`,
    `**Feed** works best when you're regularly posting on social media, are active with your work and posting regularly about what you do. In other words, just keep doing what you're doing! 
  
You don't have to be posting every day, just whatever 'regularly' means for you.  
  
**Feed** always works best if you are consistently engaging with your audience and active in your work.`,
  ],
]
