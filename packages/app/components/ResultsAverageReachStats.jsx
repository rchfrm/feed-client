...
const ResultsAverageReachStats = ({ className }) => {
...
ResultsAverageReachStats.propTypes = {
  className: PropTypes.string,
}

ResultsAverageReachStats.defaultProps = {
  className: '',
}

export default ResultsAverageReachStats
