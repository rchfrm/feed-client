...
const ResultsSlowGrowthStats = ({ className }) => {
  ...
  return (
    <div className={[className].join(' ')}>
      ...
      <div className="flex flex-row items-center justify-center">
        <PlusIcon className="h-6 w-6 mr-1 mb-4 hidden sm:block" fill={brandColors.instagram.bg} style={{ filter: 'brightness(75%)' }} />
        <p
...
ResultsSlowGrowthStats.propTypes = {
  className: PropTypes.string,
}

ResultsSlowGrowthStats.defaultProps = {
  className: '',
}

export default ResultsSlowGrowthStats
