...
const getConfirmationText = (platform) => {
  if (platform === 'soundcloud') return `Disconnecting your Soundcloud integration will stop Feed tracking follower data on the Results page.`
  if (platform === 'youtube') return `Disconnecting your YouTube integration will stop Feed tracking subscriber and views data on the Results page.`
  ...
  if (platform === 'twitter') return `Disconnecting your Twitter integration will stop Feed tracking your followers on the Results page.`
}
