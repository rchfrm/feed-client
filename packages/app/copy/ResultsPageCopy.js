...
There may be a delay whilst posts await approval, once promotions have started you'll be able to see your results below.`,
  ...
  noResultsNoBudget: `**Feed** hasn't started promoting your posts yet, get started by entering a daily budget [here](${ROUTES.CONTROLS}).`,
...
There may be a delay whilst posts await approval, once promotions have started you'll be able to see your results here.
  ...
  noActiveNoBudget: `### **Feed** isn't currently promoting any of your posts, [set a daily budget](${ROUTES.CONTROLS}) to get it started`,
