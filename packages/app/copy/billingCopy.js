...
export default {
  ...
  transferDescription: `To move a profile to another billing account, send a transfer request by selecting a profile and entering another user's email below.`,
