...
export default {
  ...
  profilesInfo: 'The following profiles are part of this billing account, and appear on the same invoice.',
  profileTransferRequests: 'Would you like to add the profile(s) below to your billing account?',
